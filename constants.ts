...
export const CLAH_ENTITIES: ServiceEntity[] = [
  {
    ...
    iconName: 'Hammer',
    imageUrl: IMAGES.customHome.main,
    ctaText: {
      vn: 'Tư vấn Xây dựng',
  ...
  },
  {
    ...
    iconName: 'PenTool',
    imageUrl: IMAGES.ncaDesigns.main,
    ctaText: {
      vn: 'Xem Portfolio',
      en: 'View Portfolio'
    },
  ...
  },
  {
    ...
    iconName: 'Armchair',
    imageUrl: IMAGES.designYourRooms.main,
    ctaText: {
      vn: 'Đặt hàng Custom',
      en: 'Order Custom'
    },
    ...
    offices: [
      {
        ...
        address: "161 Ung Văn Khiêm, Phường Thạnh Mỹ Tây, TP Hồ Chí Minh, Vietnam.",
